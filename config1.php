...
*/
define('VIRTUAL_PATH', 'http://jaspanag.com/gadgets/');

define('PHYSICAL_PATH', '/home/jaspan21/jaspanag.com/gadgets/'); # Physical (PHP) 'root' of application for file & upload reference
